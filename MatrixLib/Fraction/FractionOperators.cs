...
namespace MatrixLib
{
	public partial class Fraction
	{
		...
		public static Fraction Add<T>(T A, Fraction B)
		where T: struct
		{
			return B + ToFraction((dynamic)A);
		}
		public static Fraction Add<T>(Fraction A, T B)
		where T: struct
		{
			return A + ToFraction((dynamic)B);
		}
		...
		public static Fraction Sub<T>(T A, Fraction B)
		where T: struct
		{
			return B - ToFraction((dynamic)A);
		}
		public static Fraction Sub<T>(Fraction A, T B)
		where T: struct
		{
			return A - ToFraction((dynamic)B);
		}
